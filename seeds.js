...
const ProductComment = require('./models/productcomment2')
...
// ProductComment.insertMany(comments)
...
productcomment = [{
    ...
    },
    {
        ...
        comments: [{
            id: 14,
            conten: "This would be great! At the moment, I'm just starting challenges in order to save them. But this means the My Challenges section is overflowing with projects and is hard to manage. Being able to bookmark challenges would be really helpful.",
            user: {
                image: "./assets/user-images/image-suzanne.jpg",
                name: "Suzanne Chang",
                username: "upbeat1811"
...
const SeedDB = async () => {
    ...
    await ProductComment.insertMany(productcomment)
};
